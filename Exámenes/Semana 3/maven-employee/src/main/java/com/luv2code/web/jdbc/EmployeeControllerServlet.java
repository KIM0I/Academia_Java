...
public class EmployeeControllerServlet extends HttpServlet {
	...
	private void updateStudent(HttpServletRequest request, HttpServletResponse response)
		...
		employeeDbUtil.updateStudent(theEmployee);
	...
	private void loadStudent(HttpServletRequest request, HttpServletResponse response) 
		...
		Employee theEmployee = employeeDbUtil.getStudent(theStudentId);
		
		// place student in the request attribute
		request.setAttribute("THE_STUDENT", theEmployee);
	...
	private void addStudent(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		employeeDbUtil.addStudent(theEmployee);
	...
	private void listStudents(
		...
		List<Employee> employees = employeeDbUtil.getStudents();
		
		for (Employee s: employees) {
			System.out.println(s);
		}
		
		employees.add(new Employee(999, "FirstName","lastName", "email@gmail"));
		// add employees to the request
		request.setAttribute("LISTA_ESTUDIANTES", employees);
