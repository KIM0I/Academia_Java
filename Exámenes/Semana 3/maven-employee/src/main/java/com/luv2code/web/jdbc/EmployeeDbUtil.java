...
public class EmployeeDbUtil {
	...
	public void addStudent(Employee theEmployee) throws Exception {
	...
	public Employee getStudent(String theStudentId) throws Exception {
		...
		try {
			...
			if (myRs.next()) {
				...
				theEmployee = new Employee(studentId, firstName, lastName, email);
			}
			else {
	...
	public void updateStudent(Employee theEmployee) throws Exception {
